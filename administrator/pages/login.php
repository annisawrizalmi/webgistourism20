  ...
  <body>
      ...
      *********************************************************************************************************************************************************** -->
		      <form class="form-login" action="act/login.php" method="post">
		        <h2 class="form-login-heading" style="background:#ffd777; color:black; border-color:white">sign in now</h2>
                ...
                <button class="btn btn-theme btn-block" type="submit" name="submit" style="background:#ffd777; color:black; border-color:white"><i class="fa fa-lock"></i> SIGN IN</button>
