    ...
    function kecamatanTampil(){   // PENAMPILAN PEMBAGIAN KECAMATAN DI BUKITTINGGI
            ...
            $.ajax({
                ...
                success: function(rows) {
                    for (var i in rows.data) {
                        ...
                        marker.info = new google.maps.InfoWindow({
                            content: "<span style=color:black><center><b>" + name + "</b></center><br><i class='fa fa-map-marker'></i>" + address + "<br><i class='fa fa-money'></i>" + ticket + "<br><br><a class='btn btn-success fa fa-road' style='color:white' role=button' onclick='route_sekitar(\"" + pos_lat + "\",\"" + pos_lng + "\",\"" + rad_lat + "\",\"" + rad_lng + "\")' title='route' aria-controls='Route' id='btn_angkot'></a>&nbsp<a class='btn btn-success fa fa-info' style='color:white' role=button' onclick='galeri(\"" + ids + "\")' title='Info' aria-controls='Info' id='btn_gallery'></a></label>&nbsp<a class='btn btn-success fa fa-compass' style='color:white' role=button' onclick='cekNearBy()' title='Nearby' aria-controls='Nearby' id='btn_angkot'></a> <a class='btn btn-success fa fa-map-marker' style='color:white' role=button' onclick='setLastPos(" + rad_lat + ", " + rad_lng + ")' title='I am Here' id='btn_here'></a></span>",
                            pixelOffset: new google.maps.Size(0, -1)
                        });
                        marker.info.open(map, marker);
                    ...
                    // Tombol Angkot
                    $('#label_angkot').empty();
                    $('#label_angkot').append("<a class='btn btn-default' role='button' data-toggle='collapse'  onclick='angkot_sekitar(\"" + ids + "\")' title='Nearby' aria-controls='Nearby' id='btn_angkot'><i class='fa fa-compass' style='color:white;''></i><label>&nbsp Angkot</label></a>")

                    // Tombol Gllaery
                    $('#label_gallery').empty();
                    $('#label_gallery').append("<a class='btn btn-default' role='button' data-toggle='collapse'  onclick='galeri(\"" + ids + "\")' title='Nearby' aria-controls='Nearby' id='btn_gallery'><i class='fa fa-compass' style='color:white;''></i><label>&nbsp Gallery</label></a>")
            ...
            $.ajax({
                ...
                success: function(rows) {
                    ...
                    for (var i in rows) {
                        ...
                        $('#kanan_table').append("<tr><td>" + name + "</td><td><a role='button'  class='btn btn-success fa fa-info' title='info' onclick='data_tourism_1_info(\"" + id + "\")'></a></td><td><a role='button' title='angkot' class='btn btn-success fa fa-taxi' onclick='angkot_sekitar(\"" + id + "\")'></a></td></tr>");
                    } //end for
                }
            }); //end ajax  
            ...
            $.ajax({
                ...
                success: function(rows) {
                    ...
                    for (var i in rowtw) {
                        ...
                        var lng = row.lng;
                        var lat = row.lat;
                        $('#kanan_table').append("<tr><td>" + name + "</td><td><a role='button' class='btn btn-success fa fa-info' title='info' onclick='data_tourism_1_info(\"" + id + "\")'>&nbsp</a></td><td><a role='button' class='btn btn-success fa fa-road' title='route' onclick='route_sekitar(\"" + pos_lat + "\",\"" + pos_lng + "\",\"" + lat + "\",\"" + lng + "\")'></a></td></tr>");
        ...
        *********************************************************************************************************************************************************** */
        ...
        function objek_sekitar_angkot(id_angkot) { // KLIK TAMPILKAN, SETELAH MEMILIH OBJECT NYA DENGAN CHECK BOX
            ...
            if (!document.getElementById("check_i").checked && !document.getElementById("check_k").checked && !document.getElementById("check_m").checked && !document.getElementById("check_oo").checked && !document.getElementById("check_tw").checked && !document.getElementById("check_h").checked && !document.getElementById("check_r").checked) {
                document.getElementById('modal_title').innerHTML = "Info";
                document.getElementById('modal_body').innerHTML = "Select An Object First";
                $('#myModal').modal('show');
            } else {
                $('#view_table_sekitar').show();
            }
            ...
            $.ajax({
                ...
                success: function(rows) {
                    for (var i in rows) {
                        ...
                        $('#table_kanan_tourism').append("<tr><td>" + name + "</td><td><a role='button' class='btn btn-success fa fa-info' title='info' style='margin-right:10px'  onclick='modal_tw(\"" + id + "\") '></a><a role='button' class='btn btn-success fa fa-picture-o' style='margin-right:10px' onclick='galeri(\"" + id + "\")'></a><a role='button' title='angkot' class='btn btn-success fa fa-bus' onclick='route_angkot(\"" + lat2 + "\",\"" + lon2 + "\",\"" + lat + "\",\"" + lon + "\",\"" + id_angkot + "\",\"" + id + "\")'></a></td></tr>");
                    } //end for
                }
            }); //end ajax  
        }
        ...
        *********************************************************************************************************************************************************** */
            ...
            $.ajax({
                ...
                success: function(rows) {
                    for (var i in rows) {
                        ...
                        klikInfoWindow(id, marker);
                        map.setCenter(centerBaru);
                        $('#table_kanan_industry').append("<tr><td>" + name + "</td><td><a role='button' class='btn btn-success fa fa-road' title='route' style='margin:4px' onclick='route_sekitar(\"" + latitude + "\",\"" + longitude + "\",\"" + lat + "\",\"" + lon + "\")'></a><a role='button' class='btn btn-success fa fa-info' title='info'  style='margin:4px' onclick='modal_small_industry(\"" + id + "\")'></a><a role='button' class='btn btn-success fa fa-map-marker' style='margin:4px' title='position' onclick='set_center(\"" + lat + "\",\"" + lon + "\",\"" + name + "\")'></a>\<a role='button' class='btn btn-success fa fa-taxi' style='margin:4px' title='angkot' onclick='angkot_sekitar_lagi(\"" + id + "\")'></a></td></tr>");
                    } //end for
                }
            }); //end ajax  
        }
            ...
            $.ajax({
                ...
                success: function(rows) {
                    for (var i in rows) {
                        ...
                        $('#table_kanan_culinary').append("<tr><td>" + name + "</td><td><a role='button' title='route' style='margin:4px' class='btn btn-success fa fa-road' onclick='route_sekitar(\"" + latitude + "\",\"" + longitude + "\",\"" + lat + "\",\"" + lon + "\")'></a><a role='button' style='margin:4px' class='btn btn-success fa fa-info' title='info' onclick='modal_kuliner(\"" + id + "\")'></a><a role='button' title='position' style='margin:4px' class='btn btn-success fa fa-map-marker' onclick='set_center(\"" + lat + "\",\"" + lon + "\",\"" + name + "\")'></a><a role='button' style='margin:4px' class='btn btn-success fa fa-taxi' title='angkot' onclick='angkot_sekitar_lagi(\"" + id + "\")'></a></td></tr>");
                    } //end for
                }
            }); //end ajax  
        }
            ...
            $.ajax({
                ...
                success: function(rows) {
                    for (var i in rows) {
                        ...
                        $('#table_kanan_worship').append("<tr><td>" + name + "</td><td><a role='button' style='margin:4px' class='btn btn-success fa fa-road' title='route' onclick='route_sekitar(\"" + latitude + "\",\"" + longitude + "\",\"" + lat + "\",\"" + lon + "\")'></a><a role='button'  style='margin:4px' title='info' class='btn btn-success fa fa-info' onclick='modal_masjid(\"" + id + "\")'></a><a role='button' style='margin:4px' title='position' class='btn btn-success fa fa-map-marker' onclick='set_center(\"" + lat + "\",\"" + lon + "\",\"" + name + "\")'></a><a role='button' style='margin:4px' class='btn btn-success fa fa-taxi' title='angkot' onclick='angkot_sekitar_lagi(\"" + id + "\")'></a></td></tr>");
                    } //end for
                }
            }); //end ajax  
        }
            ...
            $.ajax({
                ...
                success: function(rows) {
                    for (var i in rows) {
                        ...
                        $('#table_kanan_souvenir').append("<tr><td>" + name + "</td><td><a role='button' style='margin:4px' title='route' class='btn btn-success fa fa-road' onclick='route_sekitar(\"" + latitude + "\",\"" + longitude + "\",\"" + lat + "\",\"" + lon + "\")'></a><a role='button' style='margin:4px' class='btn btn-success fa fa-info' title='info' onclick='modal_oo(\"" + id + "\")'></a><a role='button' style='margin:4px' class='btn btn-success fa fa-map-marker' title='position' onclick='set_center(\"" + lat + "\",\"" + lon + "\",\"" + name + "\")'></a><a role='button' style='margin:4px' class='btn btn-success fa fa-taxi' title='angkot' onclick='angkot_sekitar_lagi(\"" + id + "\")'></a></td></tr>");
                    } //end for
                }
            }); //end ajax  
        }
            ...
            $.ajax({
                ...
                success: function(rows) {
                    for (var i in rows) {
                        ...
                        $('#table_kanan_tourism').append("<tr><td>" + name + "</td><td><a role='button' style='margin:4px' title='route' class='btn btn-success fa fa-road' onclick='route_sekitar(\"" + latitude + "\",\"" + longitude + "\",\"" + lat + "\",\"" + lon + "\")'></a><a role='button' style='margin:4px' title='info' class='btn btn-success fa fa-info' onclick='modal_tw(\"" + id + "\")'></a><a role='button' style='margin:4px' title='position' class='btn btn-success fa fa-map-marker' onclick='set_center(\"" + lat + "\",\"" + lon + "\",\"" + name + "\")'></a><a role='button' style='margin:4px' class='btn btn-success fa fa-taxi' title='angkot' onclick='angkot_sekitar_lagi(\"" + id + "\")'></a></td></tr>");
                    } //end for
                }
            }); //end ajax  
            ...
            $.ajax({
                ...
                success: function(rows) {
                    for (var i in rows) {
                        ...
                        $('#table_kanan_hotel').append("<tr><td>" + name + "</td><td><a role='button' style='margin:4px' title='route' class='btn btn-success fa fa-road' onclick='route_sekitar(\"" + latitude + "\",\"" + longitude + "\",\"" + lat + "\",\"" + lon + "\")'></a><a role='button' style='margin:4px' title='info' class='btn btn-success fa fa-info' onclick='modal_hotel(\"" + id + "\")'></a><a role='button' style='margin:4px' title='position' class='btn btn-success fa fa-map-marker' onclick='set_center(\"" + lat + "\",\"" + lon + "\",\"" + name + "\")'></a><a role='button' style='margin:4px' class='btn btn-success fa fa-taxi' title='angkot' onclick='angkot_sekitar_lagi(\"" + id + "\")'></a></td></tr>");
                    } //end for
                }
            }); //end ajax  
        }
            ...
            $.ajax({
                ...
                success: function(rows) {
                    for (var i in rows) {
                        ...
                        $('#table_kanan_restaurant').append("<tr><td>" + name + "</td><td><a role='button' style='margin:4px' title='route' class='btn btn-success fa fa-road' onclick='route_sekitar(\"" + latitude + "\",\"" + longitude + "\",\"" + lat + "\",\"" + lon + "\")'></a><a role='button' style='margin:4px' title='info' class='btn btn-success fa fa-info' onclick='modal_restaurant(\"" + id + "\")'></a><a role='button' style='margin:4px' title='position' class='btn btn-success fa fa-map-marker' onclick='set_center(\"" + lat + "\",\"" + lon + "\",\"" + name + "\")'></a><a role='button' style='margin:4px' class='btn btn-success fa fa-taxi' title='angkot' onclick='angkot_sekitar_lagi(\"" + id + "\")'></a></td></tr>");
                    } //end for
                }
            }); //end ajax  
        }
            ...
            $.ajax({
                ...
                success: function(rows) {
                    for (var i in rows) {
                        ...
                        $('#table_kanan_restaurant').append("<tr><td>" + name + "</td><td><a role='button' style='margin:4px' title='route' class='btn btn-success fa fa-road' onclick='route_sekitar(\"" + latitude + "\",\"" + longitude + "\",\"" + lat + "\",\"" + lon + "\")'></a><a role='button' style='margin:4px' title='info' class='btn btn-success fa fa-info' onclick='modal_event(\"" + id + "\")'></a><a role='button' style='margin:4px' class='btn btn-success fa fa-map-marker' title='position' onclick='set_center(\"" + lat + "\",\"" + lon + "\",\"" + name + "\")'></a><a role='button' style='margin:4px' class='btn btn-success fa fa-taxi' title='angkot' onclick='angkot_sekitar_lagi(\"" + id + "\")'></a></td></tr>");
                    } //end for
                }
            }); //end ajax  
        }
        ...
        function angkot_sekitar(id) { // Menu Angkot - List Angkot
            ...
            $.ajax({
                url: server + '_detail_angkot.php?id_tourism=' + id,
                data: "",
                dataType: 'json',
                success: function(rows) {
                    for (var i in rows) {
                        ...
                        console.log(ids);
                        route_angkot_1(id, color);
                        $('#table_kanan_angkot').append("<tr><td>" + destination + "</td><td><a role='button'  class='btn btn-success fa fa-info' title='info' onclick='modal_angkot(\"" + ids + "\")' title='info'></a><a style='margin-left:10px' role='button' class='btn btn-success fa fa-road' title='route' onclick='clearangkot();route_angkot(\"" + lat2 + "\",\"" + lng2 + "\",\"" + lat + "\",\"" + lng + "\",\"" + ids + "\",\"" + id + "\")'></a></td></tr>");
                    }
                }
            });
        }
            ...
            $.ajax({
                ...
                success: function(rows) {
                    for (var i in rows) {
                        ...
                        console.log(id);
                        route_angkot_1(id, color);
                        $('#table_kanan_angkot').append("<tr><td>" + destination + "</td><td><a role='button' class='btn btn-success fa fa-info' onclick='modal_angkot(\"" + ids + "\")' title='info'></a><a style='margin-left:10px' role='button' class='btn btn-success fa fa-bus' onclick='clearangkot();route_angkot(\"" + lat2 + "\",\"" + lng2 + "\",\"" + lat + "\",\"" + lng + "\",\"" + ids + "\",\"" + id + "\")' title='angkot'></a></td></tr>");
                    }
                }
            });
        } */
