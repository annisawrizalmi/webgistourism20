      ...
      *********************************************************************************************************************************************************** -->
		      <form class="form-login" action="act/login.php" method="post">
		        ...
		        <div class="login-wrap">       
		            ...
		            <button class="btn btn-theme btn-block" type="submit" name="submit" style="background:black;border-color:white"><i class="fa fa-lock"></i> SIGN IN</button>
		            <hr>
                <a href="../" class="btn btn-theme btn-block"style="background:black;border-color:white">Back
		        </div>
		      </form>	  	
