                    ...
                    <div class="panel-body">
                      <table class="table">
                        ...
                        while($data = pg_fetch_array($hasil)){
                         ...
                         ?>
                          <tr><td><h4><?php echo $nama ?></h4></td><td><a href="?page=tourism_detail&id=<?php echo $id ?>"><i class="btn btn-success fa fa-eye" style="color: white;" title="See Data"></i></a></td></tr>
                        <?php } ?>                          
                        </tbody>          
                      </table>
