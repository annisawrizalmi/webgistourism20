	        ...
	        <div class="panel-body">
				<table>
					<tbody  style='vertical-align:top;'>
						...
						<tr><td><a href="?page=formsetF&id=<?php echo $id ?>" class="btn btn-round btn-success" title="Set Facility"><i class="fa fa-edit"></i> Set Facility</a></td></tr></tr>
						<tr><td><br></td></tr>
					</tbody>					
				</table>

				<div class="btn-group">
					<a href="?page=tourism_update&id=<?php echo $id ?>" class="btn btn-primary" title="Edit Data"><i class="fa fa-edit"></i>&nbsp Edit Data</a>
					<a class='btn btn-round' role='button' data-toggle='collapse' href='#info' onclick='' title='Add Info' aria-controls='Nearby'><i class='btn btn-info fa fa-plus' style='color:black;'></i><label>&nbsp Add Info</label>
                            </a>
				</div>
                      ...
                      while ($rows = pg_fetch_array($result)) 
                        {
                          ...
                          echo "<tr><td>$tgl</td><td>$info</td><td><a href='act/info_delete.php?id_informasi=$id_info' class='btn btn-sm btn-danger' title='Delete'><i class='fa fa-trash-o'></i></a></td></tr>";
                        }
		...
		<div class"row">
			<div class="col-sm-12"> <!-- menampilkan peta-->
			    <section class="panel">
			        ...
			        <div class="panel-body">
                        <div class="html5gallery" style="max-height:700px;overflow:auto;" data-skin="horizontal" data-width="450" data-height="290" data-resizemode="fit">  
				    	<?php
							$id=$_GET['id'];
