    ...
    <section class="panel">
        <div class="panel-body">
           <!--  <?php 
            ...
            ?> -->
            <a href="?page=user_add" class="btn btn-compose" title="Add User"><i class="fa fa-plus"></i> Add List User</a>
            <div class="box-body">
                    ...
                    <table id="example3" class="table table-hover table-bordered table-striped">
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="?page=user_update&username=<?php echo $username; ?>" class="btn btn-sm btn-success" title='Update'><i class="fa fa-edit"></i>Update</a>
                            			<a href="act/delete_user.php?id=<?php echo $username; ?>" class="btn btn-sm btn-danger" title='Delete'><i class="fa fa-trash-o"></i></a>
                        			</div>
                                </td>
                            </tr>
                            <?php } ?>
