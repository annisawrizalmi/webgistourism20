...
<html lang="en">
  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      <!--header start-->
      <header class="header black-bg" style="background: black; border-bottom: 1px solid black">
        <div class="sidebar-toggle-box" style="background: black">
        ...
        <div class="top-menu" style="background: black">
              ...
              <div class="row">
                <div class="col-lg-8 main-chart">    
                      ...
                      <div class="col-md-12 col-sm-12 mb">
                        <div class="white-panel pns">
                          ...
                          <header class="panel-heading" style="float:left">
                           ...
                           <label id="tombol">
                            <a type="button" onclick="legenda()" id="showlegenda" class="btn btn-success" data-toggle="tooltip" title="Legenda" style="margin-right:5px;"><i class="fa fa-eye" style="color:white;"></i></a>
                            </label>
                          </header>
                      ...
                      <div class="col-md-12 col-sm-12 mb">
                        <div class="white-panel pns" style="height:auto;padding-bottom:20px">
                           <div style="margin:0px 20px 10px 20px">
                             <h5 class="btn btn-compose" style="background-color:black; border-colom:1px solid black" >Object Information</h5>
                           </div>
                  ...
                  <div id="view_tracking" class="row" style="display:none;color:black">
                      <div class="col-md-12 col-sm-12 mb">
                        <div class="white-panel pns" style="height:800px">
                      ...
                      <div class="white-panel pns" style="height: 510px;">
                        ...
                        <div id="populertourism">
                          <div class="container2">
                            <div class="row2" >
                              <div class="mySlides" style="padding: 5px;padding-right: 15px;">
                              ...
                              <div class="mySlides" style="padding: 5px;padding-right: 15px;">
                                <p style="color: white; background-color: black;">
                                  <a href="" onclick="galleryreco('tw004')"><img src="../_foto/tw0041.jpg" style="width:100%"></a>Lobang Jepang</p>
                              </div>

                              <div class="mySlides" style="padding: 5px;padding-right: 15px;">
                                <p style="color: white; background-color: black;">
                                <a href="" onclick="galleryreco('tw007')"><img src="../_foto/tw0071.jpg" style="width:100%"></a>Pustaka Bung Hatta</p>
                              </div>
                                
                              <div class="mySlides" style="padding: 5px;padding-right: 15px;">
                                <p style="color: white; background-color: black;">
                                  <a href="" onclick="galleryreco('tw011')"><img src="../_foto/tw0112.jpg" style="width:100%"></a>Taman Panorama Ngarai Sianok</p>
                              </div>
                            ...
                            <div class="row2">
                              <div class="column">
                                <img class="demo cursor" title="Jam Gadang" src="../_foto/tw0012.jpg" style="width:100%;" onclick="currentSlide(1)">
                              </div>
                              <div class="column">
                                <img class="demo cursor" title="Lobang Jepang" src="../_foto/tw0041.jpg" style="width:100%" onclick="currentSlide(2)">
                              </div>
                              <div class="column">
                                <img class="demo cursor" title="Pustaka Bung Hatta" src="../_foto/tw0071.jpg" style="width:100%" onclick="currentSlide(3)">
                              </div>
                              <div class="column">
                                <img class="demo cursor" title="Taman Panorama Ngarai Sianok" src="../_foto/tw0112.jpg" style="width:100%" onclick="currentSlide(4)">
                              </div>
                      ...
                      <div id="view_kanan_table1" class="col-md-4 col-sm-4 mb" style="margin-top:0px; display:none;">
                        <div class="white-panel pns">
                           <div class="white-header" style="height:40px;margin:20px;background:white;color:black">
                             <h5 class="btn btn-compose" style="background-color:black;border-colom: 1px solid black" id="judul_table">Object Arround</h5>
                           </div>
                           <div class="row">
                             <div class="col-sm-6 col-xs-6"></div>
                           </div>
                      ...
                      <div id="view_table_sekitar" class="col-md-4 col-sm-4 mb" style="display:none">
                        <div class="white-panel pns" style="height:510px">
                           <div class="white-header" style="height:40px;margin:20px;margin-top:0px;background:white;color:black">
                             <h5 class="btn btn-compose" style="background-color:black;border-bottom:black border-colom: 1px solid black">Search Results Object Around</h5>
                           </div>
                           <div class="row">
                             <div class="col-sm-6 col-xs-6"></div>
                           </div>
                      ...
                      <div id="view_kanan_track" class="col-md-4 col-sm-4 mb" style="margin-top:20px;display:none">
                        <div class="white-panel pns">
                           <div class="white-header" style="height:40px;margin:20px;background:white;color:white">
                             <h5 class="btn btn-compose" style="background-color:black;border-colom: 1px solid black" id="judul_select">Angkot Recommendations</h5>
                           </div>
                           <div class="row">
                             <div class="col-sm-6 col-xs-6"></div>
                           </div>
...
{
  $('#tombol').empty();
  $('#tombol').append('<a type="button" id="hidelegenda" onclick="hideLegenda()" class="btn btn-default " data-toggle="tooltip" title="Hidden Legenda" style="margin-right: 7px;"><i class="fa fa-eye-slash"></i></a> ');
